...
export function ActionButton({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex min-h-11 items-center justify-center gap-2 rounded-xl px-5 py-2.5 text-sm font-semibold transition-all cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#ED7860] disabled:cursor-not-allowed",
        variants[variant],
        fullWidth && "w-full",
        className,
      )}
